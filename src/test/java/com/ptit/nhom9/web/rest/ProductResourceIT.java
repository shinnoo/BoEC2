...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).price(DEFAULT_PRICE).cartId(DEFAULT_CART_ID);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).price(UPDATED_PRICE).cartId(UPDATED_CART_ID);
        return product;
    }
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getCartId()).isEqualTo(DEFAULT_CART_ID);
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).cartId(UPDATED_CART_ID);
        ...
        assertThat(testProduct.getCartId()).isEqualTo(UPDATED_CART_ID);
    }
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.cartId(UPDATED_CART_ID);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).cartId(UPDATED_CART_ID);
