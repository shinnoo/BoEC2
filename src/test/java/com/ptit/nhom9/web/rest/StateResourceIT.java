...
class StateResourceIT {
    ...
    public static State createEntity(EntityManager em) {
        State state = new State().name(DEFAULT_NAME).taxRate(DEFAULT_TAX_RATE);
        return state;
    }
    ...
    public static State createUpdatedEntity(EntityManager em) {
        State state = new State().name(UPDATED_NAME).taxRate(UPDATED_TAX_RATE);
        return state;
    }
    ...
    void createState() throws Exception {
        ...
        assertThat(testState.getTaxRate()).isEqualTo(DEFAULT_TAX_RATE);
    }
    ...
    void putNewState() throws Exception {
        ...
        updatedState.name(UPDATED_NAME).taxRate(UPDATED_TAX_RATE);
        ...
        assertThat(testState.getTaxRate()).isEqualTo(UPDATED_TAX_RATE);
    }
    ...
    void fullUpdateStateWithPatch() throws Exception {
        ...
        partialUpdatedState.name(UPDATED_NAME).taxRate(UPDATED_TAX_RATE);
