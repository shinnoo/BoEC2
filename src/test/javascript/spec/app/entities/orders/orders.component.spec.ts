...
describe('Component Tests', () => {
  describe('Orders Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      ordersServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(ordersServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(ordersServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(ordersServiceStub.retrieve.callCount).toEqual(1);
    });
  });
});
