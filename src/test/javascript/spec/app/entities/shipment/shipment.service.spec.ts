...
import { Shipment } from '@/shared/model/shipment.model';
...
describe('Service Tests', () => {
  describe('Shipment Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Shipment(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should partial update a Shipment', async () => {
      ...
      it('should not partial update a Shipment', async () => {
