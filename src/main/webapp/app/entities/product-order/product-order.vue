  ...
  <div>
          ...
          <tr v-for="productOrder in productOrders" :key="productOrder.id" data-cy="entityTable">
            ...
            <td>
              <div v-if="productOrder.order">
                <router-link :to="{ name: 'OrdersView', params: { ordersId: productOrder.order.id } }">{{
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="boEcApp.productOrder.delete.question" data-cy="productOrderDeleteDialogHeading">Confirm delete operation</span></span
      >
