<template>
  <div>
    <h2 id="page-heading" data-cy="StateHeading">
      <span id="state-heading">States</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="boEcApp.state.delete.question" data-cy="stateDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-state-heading">Are you sure you want to delete this State?</p>
      </div>
    ...
    <div v-show="states && states.length > 0">
