  ...
  <div>
      ...
      <table class="table table-striped" aria-describedby="products">
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('cartId')">
              <span>Cart Id</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'cartId'"></jhi-sort-indicator>
            </th>
            <th scope="row"></th>
          </tr>
        </thead>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="boEcApp.product.delete.question" data-cy="productDeleteDialogHeading">Confirm delete operation</span></span
      >
