<template>
  <div>
    <h2 id="page-heading" data-cy="PaymentHeading">
      <span id="payment-heading">Payments</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="boEcApp.payment.delete.question" data-cy="paymentDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-payment-heading">Are you sure you want to delete this Payment?</p>
      </div>
